...
function home1(){
  ...
  var font_prov = [['leitor.net','wonderland','manytoon'],[0,31,58]];
  for(let i = 0; i < 3; i++){
  ...
  sma.innerHTML = `version = ${version} created by: &copy; king`;
